...
_C.AVA.FRAME_DIR = "/media/di-01/Elements/park/preprocessing/frames/"

# Directory path for files of frame lists.
_C.AVA.FRAME_LIST_DIR = (
    "/media/di-01/Elements/park/preprocessing/frames_list/"
)

# Directory path for annotation files.
_C.AVA.ANNOTATION_DIR = (
    "/media/di-01/Elements/park/preprocessing/annotations/"
)

# Filenames of training samples list files.
_C.AVA.TRAIN_LISTS = ["train_frames.csv"]

# Filenames of test samples list files.
_C.AVA.TEST_LISTS = ["val_frames.csv"]
...
# _C.AVA.TEST_PREDICT_BOX_LISTS = ["Detection_val_predicted_boxes.csv"]
_C.AVA.TEST_PREDICT_BOX_LISTS = ["val_predict.csv"]

# This option controls the score threshold for the predicted boxes to use.
_C.AVA.DETECTION_SCORE_THRESH = 0.8
...
_C.AVA.LABEL_MAP_FILE = "park_action_list.pbtxt"

# The name of the file to the ava exclusion.
# _C.AVA.EXCLUSION_FILE = "ava_val_excluded_timestamps_v2.2.csv"
_C.AVA.EXCLUSION_FILE = ""

# The name of the file to the ava groundtruth.
_C.AVA.GROUNDTRUTH_FILE = "val.csv"
...
_C.TENSORBOARD.CLASS_NAMES_PATH = "/home/di-01/git/SlowFast/slowfast_label.json"

# Path to a json file for categories -> classes mapping
# in the format {"parent_class": ["child_class1", "child_class2",...], ...}.
# _C.TENSORBOARD.CATEGORIES_PATH = "/home/di-01/git/SlowFast/category_json.json"
...
# _C.TENSORBOARD.CONFUSION_MATRIX.SUBSET_PATH = "/home/di-01/git/SlowFast/histogram_txt.txt"
...
# _C.TENSORBOARD.HISTOGRAM.SUBSET_PATH = "/home/di-01/git/SlowFast/histogram_txt.txt"
...
# Path to a json file providing class_name - id mapping
# in the format {"class_name1": id1, "class_name2": id2, ...}.
_C.DEMO.LABEL_FILE_PATH = "/home/di-01/git/SlowFast/slowfast_label.json"
...
# _C.DEMO.DETECTRON2_WEIGHTS = "/home/di-01/git/SlowFast/detectron2/detectron2/model_zoo/model_final_280758.pkl"
