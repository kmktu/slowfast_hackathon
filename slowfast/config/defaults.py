...
_C.TENSORBOARD.CLASS_NAMES_PATH = "/mnt/learning_mount/slowfast_train/preprocessing_kinetic/data/kinetic_fmt/classids.json"
...
# Path to a json file providing class_name - id mapping
# in the format {"class_name1": id1, "class_name2": id2, ...}.
_C.DEMO.LABEL_FILE_PATH = "/mnt/learning_mount/slowfast_train/preprocessing_kinetic/data/kinetic_fmt/classids.json"
