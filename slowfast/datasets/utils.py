...
def get_sequence(center_idx, half_len, sample_rate, num_frames):
    ...
    # print("range : ",range(center_idx - half_len, center_idx + half_len, sample_rate))
    # print("list : ", list(range(center_idx - half_len, center_idx + half_len, sample_rate)))
    for seq_idx in range(len(seq)):
        # print("seq_idx : ",seq_idx)
        if seq[seq_idx] < 0:
            seq[seq_idx] = 0
        elif seq[seq_idx] >= num_frames:
            # print("seq[seq_idx] : ", seq[seq_idx], num_frames)
