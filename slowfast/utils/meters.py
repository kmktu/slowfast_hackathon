...
class TestMeter(object):
    ...
    def finalize_metrics(self, ks=(1, 5)):
        ...
        """
        final_log_txt = open("SlowFast_log_final.txt", 'w')
...
class TrainMeter(object):
    ...
    def log_epoch_stats(self, cur_epoch, log_txt):
        """
        Log the stats of the current epoch.
        Args:
            cur_epoch (int): the number of current epoch.
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            ...
            log_txt.write("===================================================")
            log_txt.write(" TrainEpoch Calculation Top1, Top5 ")
            log_txt.write("===================================================\n")
            log_txt.write("top1_err : " + str(top1_err) + ", top1_acc : " + str(100 - top1_err)
                          + ", top5_err : " + str(top5_err) + ", top5_acc : " + str(100 - top5_err) + "\n")
...
class ValMeter(object):
    ...
    def log_epoch_stats(self, cur_epoch, log_txt):
        ...
        if self._cfg.DATA.MULTI_LABEL:
            ...
            stats["num_top1_mis"] = self.num_top1_mis
            stats["num_top5_mis"] = self.num_top5_mis

            log_txt.write("===================================================")
            log_txt.write(" ValEpoch Calculation Top1, Top5 ")
            log_txt.write("===================================================\n")
            # for label in self.all_labels:
            #     log_txt.write("label : " + str(label) + ", pred : " + str(self.all_preds) + "\n")
            log_txt.write("top1_err : " + str(top1_err) + ", top1_acc : " + str(100 - top1_err) + ", top5_err : "
                          + str(top5_err) + ", top5_acc : " + str(100 - top5_err) + "\n")
